...
exports.devis = async (req, res) => {
  try {
    const data = {
      ...
      showFodec: req.body.fodec,
      totalLetters: numberToFrench(req.body.total),
    };
